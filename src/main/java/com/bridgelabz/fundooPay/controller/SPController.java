...
import com.bridgelabz.fundooPay.bean.ServiceType;
import com.bridgelabz.fundooPay.persistence.ServiceProviderDAO;
import com.bridgelabz.fundooPay.service.business_service.ServiceProviderService;
import com.bridgelabz.fundooPay.service.business_service.ServiceProviderServiceImpl;
...
public class SPController {
	...
	/*--------------------------------SERVICE PROVIDER REGISTRATION------------------------------------------*/
	 @RequestMapping(value = "/register/{serviceType}", method = RequestMethod.POST, produces = "application/json")
	    ...
	    @ApiResponses(value = {
	            @ApiResponse(code = 200, message = "Service provider Registered Successfully"),
	            @ApiResponse(code = 401, message = "You are not authorized access the resource"),
	            @ApiResponse(code = 404, message = "The resource not found")
	    }
	    )
	    public ResponseEntity<ServiceProvider> registerServiceProvider(@PathVariable ServiceType serviceType,@RequestBody ServiceProvider serviceProvider) {
